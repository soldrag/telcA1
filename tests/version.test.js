...
describe('Application Versioning & Build Metadata', () => {
  it('exposes semver version matching package.json (0.7.1)', () => {
    assert.equal(APP_VERSION, '0.7.1');
  });
