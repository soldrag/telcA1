  ...
  return (
    <div className="flex items-center bg-surface-inset p-1 rounded-xl border border-border-default text-xs font-semibold">
      <button
        ...
        className={`px-3 py-1 rounded-lg transition-all min-h-[44px] cursor-pointer focus-visible:ring-2 focus-visible:ring-action-primary focus-visible:ring-offset-2 ${
          filter === 'all'
      ...
      <button
        ...
        className={`px-3 py-1 rounded-lg transition-all flex items-center space-x-1.5 min-h-[44px] cursor-pointer focus-visible:ring-2 focus-visible:ring-action-primary focus-visible:ring-offset-2 ${
          filter === 'mistakes'
