...
export const TRANSLATION_CONTRACT = {
  ...
  welcome: {
    ...
    teacherSpace: {
      ...
      quickReviewDesc: 'string',
      quickReviewPlaceholder: 'string',
      quickReviewBtn: 'string',
      catalogTitle: 'string',
      inspectVariantBtn: 'string',
  ...
  exam: {
    ...
    inspectionTotalQuestions: 'string',
    finishInspectionBtn: 'string',
  ...
  results: {
    ...
    schreibenCriteria: {
      ...
      lp3: 'string',
      gruss: 'string',
      grammarPenalty: 'string',
      tutorNoteBadge: 'string',
    },
  ...
  modals: {
    ...
    createAssignment: {
      ...
      linkCopied: 'string',
      closeBtn: 'string',
      signatureProtectedNotice: 'string',
    },
  },
  assignment: {
    landingTitle: 'string',
